...
public class ImpactynUploadReviewTest extends BaseTest
{
    ...
    @Test (priority = 2 , description = "Verify user can upload a new review from Earn page")
    public void UploadFromEarnPage() throws InterruptedException {
        SoftAssert softAssertion = new SoftAssert();
        ...
        earnPage.allowAccess();

        UploadReviewPage uploadReview=earnPage.clickReviewToInspire();
        uploadReview.allowRecordingSettings();
